...
See http://github.com/psych251/jakesch2019 for the complete project.
...
To be conducted during the week of Oct 21, after this material is covered in class.
...
We used the three-point trustworthiness rating scale created for the original experiment:
...
Then, we fit a generalized linear mixed model (GLMM) with random per-participant effects to each participants' trustworthiness ratings: `lme(rating ~ profile_type * condition, random=~ 1|subject)`.
