...
Using the 'simr' package, we determined that using the original sample size (108 total participants after exclusions, across the two conditions we planned to focus on - control and primed) would provide 89.70% power (95% CI: [87.65, 91.51]) for the fixed effect of interest (see below), assuming participants are excluded at similar rates to the original study.
...
```{r}
responses <- read.csv(file="../../pilot_b_data_mturk.csv") %>% 
